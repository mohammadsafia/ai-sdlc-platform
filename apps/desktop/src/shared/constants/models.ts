...
export const ALL_AVAILABLE_MODELS: ModelOption[] = [
  ...
  // OpenAI
  { value: 'gpt-6-astra', label: 'GPT-6 Astra', provider: 'openai', description: 'Most capable', capabilities: { thinking: true, tools: true, vision: true, contextWindow: 272000 } },
  { value: 'gpt-5.6-sol', label: 'GPT-5.6 Sol', provider: 'openai', description: 'Frontier agentic coding', capabilities: { thinking: true, tools: true, vision: true, contextWindow: 272000 } },
  ...
  { value: 'gpt-5.6-terra', label: 'GPT-5.6 Terra', provider: 'openai', description: 'Balanced', capabilities: { thinking: true, tools: true, vision: true, contextWindow: 272000 } },
  { value: 'gpt-5.6-luna', label: 'GPT-5.6 Luna', provider: 'openai', description: 'Fast & cheaper', capabilities: { thinking: true, tools: true, vision: true, contextWindow: 272000 } },
  { value: 'gpt-5.5', label: 'GPT-5.5', provider: 'openai', description: 'Previous flagship', capabilities: { thinking: true, tools: true, vision: true, contextWindow: 272000 } },
...
export const PROVIDER_PRESET_DEFINITIONS: Partial<Record<BuiltinProvider, Record<string, ProviderPresetConfig>>> = {
  ...
  openai: {
    auto:     { primaryModel: 'gpt-6-astra', primaryThinking: 'high',   phaseModels: { spec: 'gpt-6-astra', planning: 'gpt-6-astra', coding: 'gpt-6-astra', qa: 'gpt-6-astra' }, phaseThinking: { spec: 'high', planning: 'high', coding: 'low', qa: 'low' } },
    complex:  { primaryModel: 'gpt-6-astra', primaryThinking: 'xhigh',  phaseModels: { spec: 'gpt-6-astra', planning: 'gpt-6-astra', coding: 'gpt-6-astra', qa: 'gpt-6-astra' }, phaseThinking: { spec: 'xhigh', planning: 'xhigh', coding: 'xhigh', qa: 'xhigh' } },
    balanced: { primaryModel: 'gpt-5.6-terra',  primaryThinking: 'medium', phaseModels: { spec: 'gpt-5.6-terra', planning: 'gpt-5.6-terra', coding: 'gpt-5.6-terra', qa: 'gpt-5.6-terra' }, phaseThinking: { spec: 'medium', planning: 'medium', coding: 'medium', qa: 'medium' } },
    quick:    { primaryModel: 'gpt-5.6-luna', primaryThinking: 'low', phaseModels: { spec: 'gpt-5.6-luna', planning: 'gpt-5.6-luna', coding: 'gpt-5.6-luna', qa: 'gpt-5.6-luna' }, phaseThinking: { spec: 'low', planning: 'low', coding: 'low', qa: 'low' } },
  },
  google: {
...
export const DEFAULT_MODEL_EQUIVALENCES: Record<string, Partial<Record<BuiltinProvider, ProviderModelSpec>>> = {
  ...
  'opus': {
    ...
    openai: { modelId: 'gpt-6-astra', reasoning: { type: 'reasoning_effort', level: 'high' } },
  ...
  'sonnet': {
    anthropic: { modelId: 'claude-sonnet-4-6', reasoning: { type: 'thinking_tokens', level: 'medium' } },
    openai: { modelId: 'gpt-5.6-terra', reasoning: { type: 'reasoning_effort', level: 'medium' } },
  ...
  'haiku': {
    ...
    openai: { modelId: 'gpt-5.6-luna', reasoning: { type: 'reasoning_effort', level: 'low' } },
  ...
  'gpt-5.6-terra': {
    openai: { modelId: 'gpt-5.6-terra', reasoning: { type: 'reasoning_effort', level: 'high' } },
    anthropic: { modelId: 'claude-opus-4-6', reasoning: { type: 'adaptive_effort', level: 'high' } },
    google: { modelId: 'gemini-2.5-pro', reasoning: { type: 'thinking_toggle', level: 'high' } },
  },
  'gpt-5.6-luna': {
...
export function getModelContextWindow(modelIdOrShorthand: string): number {
  // Direct match by shorthand (e.g., 'opus', 'gpt-6-astra')
