...
export function registerEnvHandlers(
  ...
  const generateEnvContent = (
    ...
    const content = `# Appswave Framework Environment Variables
# Managed by Appswave UI
...
# If not set, Appswave will auto-detect main/master, or fall back to current branch
