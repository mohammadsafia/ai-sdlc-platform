...
const browserMockAPI: ElectronAPI = {
  ...
  onBrdDraftDone: () => () => {},
  onBrdDraftError: () => () => {},
  designList: async () => ({ success: true, data: [] }),
  designRead: async () => ({ success: false, error: 'Not available in browser mock' }),
  designWrite: async () => ({ success: false, error: 'Not available in browser mock' }),
  designCreate: async () => ({ success: false, error: 'Not available in browser mock' }),
  designSetStatus: async () => ({ success: false, error: 'Not available in browser mock' }),
  designDraft: async () => ({ success: false, error: 'Not available in browser mock' }),
  designDraftCancel: async () => ({ success: false, error: 'Not available in browser mock' }),
  onDesignDraftChunk: () => () => {},
  onDesignDraftDone: () => () => {},
  onDesignDraftError: () => () => {},
