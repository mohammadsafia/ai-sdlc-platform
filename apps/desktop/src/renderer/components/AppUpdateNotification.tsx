        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {t(
              ...
              "A new version of Appswave is ready to download"
            )}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-3 text-sm text-warning bg-warning/10 border border-warning/30 rounded-lg p-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground">
                  {t("dialogs:appUpdate.readOnlyVolumeDescription", "Please move Appswave to your Applications folder before updating.")}
                </p>
              </div>
            </div>
          )}
